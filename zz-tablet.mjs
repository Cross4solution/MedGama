...
const SAYFALAR = [
  ['/medstream', null], ['/search', null], ['/browse/clinics', null], ['/login', null],
  ['/crm', 'klinik'], ['/crm/billing', 'klinik'], ['/crm/patients', 'klinik'], ['/crm/calendar', 'klinik'],
  ['/doctor/appointments', 'doktor'], ['/patient/appointments', 'hasta'],
];

const b = await chromium.launch();
for (const [ad, en] of [['tablet', 768], ['küçük telefon', 320]]) {
  console.log(`\n══ ${ad} (${en}px)`);
