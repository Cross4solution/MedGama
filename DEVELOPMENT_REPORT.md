...
Bu sprint kapsamında MedGama platformu üzerinde **142 commit** ile kapsamlı geliştirmeler yapılmıştır. Çalışmalar üç ana kategoride yoğunlaşmıştır:
...
Bu sprint ile MedGama platformu:
