...
export default function SiteChrome({ children, brand = 'medagama' }) {
  ...
  return (
    ...
    <div className={hasSidebar ? 'lg:pl-[10.25rem]' : ''}>
      ...
      */}
      <div className={`${hasSidebar && !hasOwnContainer ? 'hasta-govde w-full max-w-[1180px] mr-auto pl-3 lg:pl-6' : ''} ${showHeader ? (hasOwnContainer || isDoctorChat ? 'pt-[4.25rem]' : 'pt-[4rem]') : ''} ${
