...
<div class="page">
    ...
    <div class="header">
        <div class="header-top">
            <div class="header-left">
                <div class="clinic-name">{{ $clinic->fullname ?? $clinic->name ?? 'Medagama Clinic' }}</div>
    ...
    <div class="disclaimer">
        Bu belge Medagama CRM sistemi tarafından otomatik oluşturulmuştur. Geçerliliği hekim imzası ile kesinleşir.<br>
        This document was automatically generated by Medagama CRM. Validity is confirmed by the physician's signature.
    </div>
