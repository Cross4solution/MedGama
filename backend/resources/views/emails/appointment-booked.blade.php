                ...
                <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding:0 40px 32px;">
                            <p style="margin:0;font-size:11px;color:#9ca3af;text-align:center;">MedGama Healthcare Platform &bull; <a href="https://medgama.com" style="color:#0d9488;text-decoration:none;">medgama.com</a></p>
                        </td>
                    </tr>
                </table>
            </td>
