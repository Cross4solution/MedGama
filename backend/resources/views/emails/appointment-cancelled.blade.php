                ...
                <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                    <tr>
                        <td style="background:linear-gradient(135deg,#dc2626,#b91c1c);padding:32px 40px;text-align:center;">
                            ...
                            <p style="color:rgba(255,255,255,0.85);font-size:13px;margin:12px 0 0;font-weight:400;">Appointment Cancelled</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:32px 40px;">
                            <h2 style="margin:0 0 8px;font-size:20px;font-weight:700;color:#111827;">Hello, {{ $patientName }}</h2>
                            <p style="margin:0 0 24px;font-size:14px;color:#6b7280;line-height:1.6;">We're sorry to inform you that your appointment has been cancelled.</p>

                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#fef2f2;border-radius:12px;padding:20px;margin-bottom:24px;">
                            ...
                            <p style="margin:0 0 8px;font-size:13px;color:#6b7280;line-height:1.6;">If you'd like to reschedule, please visit our platform or contact us directly.</p>
                        </td>
                    </tr>
                    <tr>
