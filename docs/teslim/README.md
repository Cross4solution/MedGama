# Medagama — Teslim Paketi (7 Eylül 2026)

Müşteriye giden dosyalar. Kaynak Markdown'lar `docs/` altında; PDF'ler
oradan üretilir (`pandoc → docx → LibreOffice`), elle düzenlenmez.
...
| `MUSTERIDEN-BEKLENENLER.pdf` | Müşteri'ye sorulup dönüş gelmeyenler: 6 girdi + 1 soru, tarih ve belgeyle | 2 |
