  ...
  return (
    <div className="print-exam-report" style={{ display: 'none' }}>
      ...
      <div className="print-footer">
        {t('crm.examination.print.footer', 'This report was generated by Medagama Healthcare Platform. For questions contact support@medgama.com')}
        <br />
