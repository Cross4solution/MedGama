          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="relative flex-1 max-w-sm">
              ...
              <input type="text" placeholder={t('admin.verification.searchRequests')} value={reqSearch} onChange={e => setReqSearch(e.target.value)}
                className="w-full ps-9 pr-4 py-2 border border-gray-200 rounded-xl text-sm bg-white focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-400 transition-all" />
            </div>
          </div>
