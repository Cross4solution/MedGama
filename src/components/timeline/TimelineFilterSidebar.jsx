        ...
        <div className={`px-3 transition-all duration-200 ${kompakt ? "py-2.5 space-y-2" : "px-4 pb-4 pt-2 space-y-3.5"}`}>
          ...
          <div>
            ...
            <div className="relative group">
              <Search className="w-4 h-4 text-gray-400 absolute start-3.5 top-1/2 -translate-y-1/2 group-focus-within:text-teal-500 transition-colors" />
              <input
                type="search"
                value={localQuery}
                ...
                className="w-full ps-10 pr-3 py-2 border border-gray-200 rounded-lg text-sm bg-gray-50/50 hover:bg-white hover:border-gray-300 focus:bg-white focus:ring-2 focus:ring-teal-500/20 focus:border-teal-400 transition-all placeholder:text-gray-400"
              />
            </div>
          </div>
