    ...
    <aside className="order-1 lg:order-1 lg:sticky lg:top-24 h-max">
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg shadow-gray-200/50 border border-gray-100 overflow-hidden">
        ...
        <div className="p-5 space-y-5">
          {/* Search */}
          <div>
            <label className="block text-xs font-semibold text-gray-500 mb-2 uppercase tracking-wider">{t('medstream.search')}</label>
          ...
          <div className="block md:hidden">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-xs font-semibold text-gray-500 mb-2 uppercase tracking-wider">{t('medstream.country')}</label>
                <CountryCombobox
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-500 mb-2 uppercase tracking-wider">{t('medstream.specialization')}</label>
                <SelectCombobox
