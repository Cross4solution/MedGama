        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              name="firstName"
              id="kayit-firstName"
              aria-invalid={(errors.firstName || localErrors.firstName) ? 'true' : undefined}
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              name="lastName"
              id="kayit-lastName"
              aria-invalid={(errors.lastName || localErrors.lastName) ? 'true' : undefined}
        ...
        <div className="md:col-span-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              name="username"
              id="kayit-username"
              aria-invalid={(errors.username || localErrors.username) ? 'true' : undefined}
              aria-describedby={(errors.username || localErrors.username) ? 'kayit-username-hata' : undefined}
              value={fd.username ?? ''}
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              name="clinicName"
              id="kayit-clinicName"
              aria-invalid={(errors.clinicName || localErrors.clinicName) ? 'true' : undefined}
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              name="email"
              id="kayit-email"
              aria-invalid={(errors.email || localErrors.email) ? 'true' : undefined}
          ...
          {!errors.confirmPassword && fd.confirmPassword && fd.password && fd.confirmPassword === fd.password && fd.password.length >= 6 && (
            ...
            <div className="w-full max-w-md flex items-center justify-end mt-3 sm:mt-4">
              <button
                type="button"
                onClick={handleNext}
                className="inline-flex items-center gap-2 bg-teal-600 text-white py-2.5 px-6 rounded-xl hover:bg-teal-700 focus:ring-4 focus:ring-teal-200 transition-colors font-semibold text-sm shadow-sm hover:shadow-md mt-2 sm:mt-3"
              >
                {t('common.next')}
