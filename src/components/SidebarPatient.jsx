...
export default function SidebarPatient() {
  ...
  // CRM bridge: always visible for professional roles (Doctor / Clinic)
  // Hospital role never sees Medstream sidebar — they land directly in CRM
  // isPro is NOT a gate here — the bridge is available to all verified professionals
