...
import { Home, Newspaper, MessageSquare, CalendarClock, Building2, Bookmark, Settings, LogOut, Bell } from 'lucide-react';
...
export default function SidebarPatient() {
  ...
  const NavItem = ({ to, icon: Icon, label, badge }) => {
    ...
    return (
      <Link
        to={to}
        className={`group flex items-center justify-between px-3 py-2 rounded-xl text-sm border transition ${
