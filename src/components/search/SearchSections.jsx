    ...
    <>
      ...
      <section className="pt-4 pb-4 bg-gradient-to-b from-gray-50 to-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-lg font-bold text-gray-900 mb-3">{t('search.sectionTitle')}</h2>
          <CustomSearch />
        </div>
      </section>
      ...
      <section id="clinics-search" className="pt-6 pb-2">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-lg font-bold text-gray-900 mb-4 text-center">{t('search.clinicSearchTitle')}</h2>
          <div className="relative max-w-3xl mx-auto">
            <GlobalSearch />
          </div>
          {/* Title for course/feature boxes under simple search */}
          <div id="discover-services" className="mt-20 mb-0 flex items-center gap-2">
            <Sparkles className="w-4.5 h-4.5 text-teal-600" />
            <h2 className="text-lg font-bold text-gray-900">{t('search.discoverServices')}</h2>
          </div>
        </div>
      </section>
    </>
