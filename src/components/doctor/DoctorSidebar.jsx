    ...
    <div className="lg:w-96 xl:w-[26rem] space-y-6">
      <div className="bg-white rounded-xl shadow-lg p-4">
        <div className="grid grid-cols-2 gap-3">
          <button className="w-full h-20 sm:h-24 bg-teal-600 text-white rounded-xl hover:bg-teal-700 transition-colors font-medium flex flex-col items-center justify-center gap-1.5 p-2">
            <Video className="w-4 h-4" />
            <span className="text-[11px] sm:text-xs text-center leading-tight">Online Consultation</span>
          </button>

          <button className="w-full h-20 sm:h-24 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors font-medium flex flex-col items-center justify-center gap-1.5 p-2">
            <img
          ...
          <button className="w-full h-20 sm:h-24 bg-purple-600 text-white rounded-xl hover:bg-purple-700 transition-colors font-medium flex flex-col items-center justify-center gap-1.5 p-2">
            <img
