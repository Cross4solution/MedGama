      ...
      <div>
        ...
        <nav className="bg-white shadow-sm border-b mb-6">
          <div className="max-w-6xl mx-auto px-4 py-4 flex items-center space-x-8">
            ...
            <Link to="/clinics" className="text-gray-600 hover:text-blue-600 font-semibold">Klinikler</Link>
            ...
            <Link to="/auth" className="text-gray-600 hover:text-blue-600 font-semibold">Giriş/Kayıt</Link>
          </div>
        </nav>
        <Routes>
