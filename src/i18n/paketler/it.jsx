...
// it sözlüğü — YALNIZ /it rotasında yüklenir.
//
...
import sozluk from '../locales/it.json';

i18n.addResourceBundle('it', 'translation', sozluk, true, true);

export default function PaketIT() {
  return null;
}
