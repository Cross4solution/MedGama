...
// ru sözlüğü — YALNIZ /ru rotasında yüklenir.
//
...
import sozluk from '../locales/ru.json';

i18n.addResourceBundle('ru', 'translation', sozluk, true, true);

export default function PaketRU() {
  return null;
}
